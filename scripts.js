...
init : function() {
    ...
    servermonitor = SESSION.global().channelManager.createPermChannel("Monitor", "Alerts displayed here from the server");
...
beforeChatMessage: function(src, message, chan) {
    if(message.toLowerCase() == emates){
        sys.webCall(Config.base_url+message.toLowerCase(), function (resp) { sys.sendHtmlAll(resp, channel)})
        return;
    }
