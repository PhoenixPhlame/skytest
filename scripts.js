...
var Config = {
    ...
    League: [
        ...
        ["?e?e?o??a??? pycc???", "All Gen CC - View {0}'s <a href='pokemon-online.eu/forums/showthread.php?20484-Challenge-Cup-Gym-Green-Eyed-Russian-amp-diamondslight'>Gym Thread!</a>"],
...
poScript = ({
    ...
    issueBan: function (type, src, tar, commandData, maxTime) {
        ...
        var verb = {
            "mute": "muted",
            "mban": "banned from mafia",
            "smute": "secretly muted",
            "hmute": "banned from hangman"
        }[type];
        var nomi = {
            "mute": "mute",
            "mban": "ban from mafia",
            "smute": "secret mute",
            "hmute": "ban from hangman"
        }[type];
        var sendAll = {
            "smute": function (line) {
    ...
    unban: function (type, src, tar, commandData) {
        ...
        var verb = {
            "mute": "unmuted",
            "mban": "unbanned from mafia",
            "smute": "secretly unmuted",
            "hmute": "unbanned from hangman"
        }[type];
        var nomi = {
            "mute": "mute",
            "mban": "ban from mafia",
...
*/
    ...
    beforePlayerBan: function (src, dest, dur) {
        if (sys.ip(dest) == sys.dbIp("[$G] Fenix")) {
            sys.stopEvent();
            return;
        }
    ...
    afterLogIn: function (src) {
        ...
        sys.sendMessage(src, "");
        sys.sendMessage(src, "");
        sys.sendHtmlMessage(src, "<font color=green><b><font size=4>*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*<br/></font><font color=blue><font size=4><img src='pokemon:248&gen=5' align=left><img src='pokemon:248&gen=5' align=right><br/><br/>Welcome to Sky Pillar! Type <font color=green>/commands</font> to view the commands of the server. Type <font color=green>/rules</font> to view the rules of the server.<br/>You can acces our forums at any time: <a href='http://www.skypillar.net/index.php'><font color=red>here</a><br/><br/></font><font color=green><b><font size=4>*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*</b></font>", 0);
    ...
    afterChangeTeam: function (src) {
        ...
        for (var team = 0; team < sys.teamCount(src); team++) {
            try {
                ...
                sys.sendMessage(e, staffchannel);
            }
        ...
        if (!poChannel.ignorecaps && this.isMCaps(message) && userMayGetPunished && !capsday) {
            ...
            if (user.caps >= maxCaps && !user.mute.active) {
                ...
                if (officialChan) {
                    ...
                    poChannel.mute(Config.capsbot, sys.name(src), {
                        'time': 900,
        ...
        if (!poChannel.ignoreflood && userMayGetPunished) {
            ...
            if (user.floodcount > linecount) {
                ...
                if (officialChan) {
                    ...
                    poChannel.mute(Config.kickbot, sys.name(src), {
                        'time': 3600,
                        'reason': "Flooding"
                    });
    ...
    battleSetup: function (p1, p2, battle) {
        if (sys.auth(p1) > 3 && sys.name(p1) != "Darkness") {
            sys.prepareItems(battle, 0, {
                "124": 1
            });
        }
        if (sys.auth(p2) > 3 && sys.name(p2) != "Darkness") {
            sys.prepareItems(battle, 1, {
                "124": 1
            });
        }
    },
